...
def tum_haberleri_cek(haber_sitesi_url):
    ...
    for haber in soup.find_all("div", class_="p12-col"):
        url_element = haber.find("a", class_="boxStyle color-magazine hbBoxMainText")
        if url_element:
...
haber_url_listesi = tum_haberleri_cek("https://www.haberler.com/magazin/")
...
with open(txt_dosya_yolu, 'a', encoding='utf-8') as file:
