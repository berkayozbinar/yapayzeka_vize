...
vectorizer = TfidfVectorizer(max_features=5000)  # Sadece max_features kullanarak düzensiz matris kullanımını devre dışı bırak
...
model.save('C:/Users/berka/OneDrive/Masaüstü/yapayzeka/models/haber.h5')